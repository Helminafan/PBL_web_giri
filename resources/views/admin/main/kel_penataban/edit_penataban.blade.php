...
<div class="container-fluid">
    ...
    <form id="validate" class="user" method="POST" autocomplete="off" action="{{ route('penataban.update',$editData->id) }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="file" class="form-control-file"  name="foto_ktp" id="fotoktp" value="{{$editData->foto_ktp}}">
                        </div>
