...
<div class="container-fluid">
    ...
    <form id="validate" class="user" method="POST" autocomplete="off" action="{{ route('boyolangu.store') }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card-body">
                    <div class="form-group row">
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" required class="form-control nik form-control-lg" id="nik" placeholder="No KK" minlength="16" maxlength="16" name="nik[]">
                            <br>
                        </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            <label for="Name">Nama Lengkap</label>
                            <input type="text" required class="form-control form-control-lg" id="nama" placeholder="Nama Lengkap" name="nama_warga[]">
                            <br>
                        </div>
                        <div class="col-sm-6 mb-3 mb-sm-0">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" required class="form-control form-control-lg" id="telepon" placeholder="Nomor Telepon" pattern="(\+62|62|0)8[1-9][0-9]{6,9}$" name="no_hp[]">
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <input type="text" required class="form-control form-control-lg" id="kelurahan" placeholder="kelurahan" name="kelurahan[]">
                            <br>
                        </div>
                    </div>
                </div>
