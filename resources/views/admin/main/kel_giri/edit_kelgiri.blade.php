...
@section('content')
    <div class="container-fluid">
        <h1 class="h3 mb-2 text-gray-800">Update Data Warga Miskin Kelurahan Giri</h1>
        ...
        <form class="user" method="POST" action="{{route('kelgiri.update', $editData->id)}}" enctype="multipart/form-data">
            @csrf
