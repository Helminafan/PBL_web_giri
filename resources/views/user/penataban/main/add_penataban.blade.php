...
@section('user')
    <div class="container-fluid">
        <h1 class="h3 mb-2 text-gray-800">Tambah Data Warga Miskin Kelurahan Penataban</h1>
        ...
        <form id="validate" class="user" method="POST" autocomplete="off" action="{{route('user_penataban.store')}}" enctype="multipart/form-data">
            @csrf
