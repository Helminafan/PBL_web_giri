...
class UserJambesariController extends Controller
{
    /**
    ...
    public function index()
    {
        $data = warga::with('user')
            ...
            ->get();
        return view('user.jambesari.main.view_jambesari', compact('data'));
    }
    ...
    {
        return view('user.jambesari.main.add_jambesari');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user_jambesari.view')->with('success', 'Data Berhasil Ditambah');
    }
